...
const assetsURL = function(dep) {
  return "/DocumenterVitepress.jl/previews/PR109/" + dep;
};
const seen = {};
...
var define_import_meta_env_default = { BASE_URL: "/DocumenterVitepress.jl/previews/PR109/", MODE: "production", DEV: false, PROD: true, SSR: false };
...
function pathToFile(path) {
  ...
  {
    if (inBrowser) {
      const base = "/DocumenterVitepress.jl/previews/PR109/";
