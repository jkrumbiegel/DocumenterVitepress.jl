...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.DTzxYcXc.js"), true ? __vite__mapDeps([0,1]) : void 0));
