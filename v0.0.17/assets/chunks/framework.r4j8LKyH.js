...
const assetsURL = function(dep) {
  return "/DocumenterVitepress.jl/v0.0.17/" + dep;
};
const seen = {};
...
var define_import_meta_env_default = { BASE_URL: "/DocumenterVitepress.jl/v0.0.17/", MODE: "production", DEV: false, PROD: true, SSR: false };
...
function pathToFile(path) {
  ...
  {
    if (inBrowser) {
      const base = "/DocumenterVitepress.jl/v0.0.17/";
